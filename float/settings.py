...
## JWT Details
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=config('ACCESS_TOKEN_LIFETIME', default=5, cast=int)),
...
## S3 Storage
AWS_S3_ENDPOINT_URL = config('S3_BUCKET_ENDPOINT_URL', default="")
AWS_S3_ACCESS_KEY_ID = config('S3_ACCESS_KEY')
AWS_S3_SECRET_ACCESS_KEY = config('S3_SECRET_KEY')
AWS_S3_REGION_NAME = config('S3_BUCKET_REGION', default="")
AWS_S3_USE_SSL=True
AWS_STORAGE_BUCKET_NAME = config('S3_BUCKET_NAME')
AWS_S3_CUSTOM_DOMAIN = config('S3_CUSTOM_DOMAIN', default="")
AWS_QUERYSTRING_EXPIRE=config('S3_QUERYSTRING_EXPIRE_TIME', default='86400')
AWS_QUERYSTRING_AUTH=config('S3_AWS_QUERYSTRING_AUTH', default=True)